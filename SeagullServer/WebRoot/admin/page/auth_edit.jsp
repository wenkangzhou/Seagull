	...
	<div id="main">
		<form action="auth.do" method="post" id="addform">
			...
			<table cellspacing="0" cellpadding="0" border="0" class="fullwidth">
				<tr>
					<td>权限名</td>
					<td><input type="text" id="auth_name" name="auth.auth_name" value="${item.auth_name}"/></td>
				</tr>
				<tr>
					<td>权限代码</td>
					<td><input type="text" id="auth_code" name="auth.auth_code" value="${item.auth_code}"/></td>
				</tr>
				<tr>
					<td></td>
